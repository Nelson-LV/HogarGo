...
// Generated with Material Theme Builder (m3.material.io/theme-builder) from seed #974400.
...
// Brand accents used directly in a few illustrative spots (streak banner, savings jar, category chips).
val BrandOrange = Color(0xFFFEAC67)
val BrandOrangeContainer = Color(0xFFFFDBC9)
val BrandOrangeDeep = Color(0xFFBB5808)
val BrandBrownStrong = Color(0xFF974400)
